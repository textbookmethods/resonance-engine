...
export default function Reference() {
    ...
    return (
        <div className="flex flex-col md:flex-row h-[75vh] bg-[#0f172a] border border-slate-700 font-mono text-sm shadow-inner overflow-hidden">
            
            {/* SIDEBAR NAVIGATION */}
            <div className="w-full md:w-64 bg-[#1e293b] border-r border-slate-700 flex flex-col shrink-0 overflow-y-auto">
                <div className="p-4 border-b border-gray-700 bg-[#0f172a]">
                    <h2 className="text-[#a855f7] font-bold text-lg tracking-widest uppercase">Database</h2>
                    ...
                    {tabs.map(tab => (
                        <button
                            ...
                            className={`text-left px-4 py-3 text-xs uppercase font-bold tracking-wider transition-colors ${
                                activeTab === tab.id 
                                    ? 'bg-[#a855f7] text-white border-l-4 border-[#e9d5ff]' 
                                    : 'text-gray-400 hover:bg-[#0f172a] hover:text-white border-l-4 border-transparent'
                            }`}
                        >
                            {tab.label}
                        </button>
            ...
            <div className="flex-1 p-6 md:p-10 overflow-y-auto text-gray-300 relative">
                ...
                {activeTab === 'elements' && (
                    <div className="animate-fade-in space-y-8 max-w-5xl">
                        <h1 className="text-3xl font-bold text-[#d1d5db] uppercase border-b border-gray-700 pb-2">Elemental Matrix</h1>
                        
                        <div className="bg-[#1e293b] border border-gray-700 p-6 shadow-md">
                            <h2 className="text-white font-bold text-xl uppercase tracking-widest mb-4">Affinity Multipliers (RPS)</h2>
                            <p className="text-gray-400 text-xs mb-6 leading-relaxed">
                                Striking a target with an element they are weak to applies a <strong className="text-[#22c55e]">1.5x Damage Multiplier</strong> and triggers an automated <strong className="text-[#a855f7]">Exploit (+4 Res)</strong> teamwork bonus. Striking a target with an element they resist applies a <strong className="text-red-500">0.5x Damage Multiplier</strong>.
                            </p>

                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                                <div className="border border-red-500 bg-[#0f172a] p-4 shadow-inner">
                                    <div className="text-red-500 font-bold text-lg mb-2 uppercase">The Primal Triangle</div>
                                    <div className="text-xs space-y-2 text-gray-300">
                                        <div><span className="text-red-500 font-bold">THERMAL</span> melts <span className="text-blue-400 font-bold">CRYO</span></div>
                                        <div><span className="text-blue-400 font-bold">CRYO</span> freezes <span className="text-green-500 font-bold">TOXIC</span></div>
                                        <div><span className="text-green-500 font-bold">TOXIC</span> chokes <span className="text-red-500 font-bold">THERMAL</span></div>
                                    </div>
                                </div>
                                <div className="border border-[#a855f7] bg-[#0f172a] p-4 shadow-inner">
                                    <div className="text-[#a855f7] font-bold text-lg mb-2 uppercase">The Cosmic Binary</div>
                                    <div className="text-xs space-y-2 text-gray-300">
                                        <div><span className="text-yellow-300 font-bold">RADIANT</span> purges <span className="text-[#a855f7] font-bold">VOID</span></div>
                                        <div><span className="text-[#a855f7] font-bold">VOID</span> consumes <span className="text-yellow-300 font-bold">RADIANT</span></div>
                                        <div className="text-gray-500 italic pt-2 border-t border-gray-800 mt-2">Mutually destructive.</div>
                                    </div>
                                </div>
                                <div className="border border-blue-400 bg-[#0f172a] p-4 shadow-inner">
                                    <div className="text-blue-400 font-bold text-lg mb-2 uppercase">The Material Binary</div>
                                    <div className="text-xs space-y-2 text-gray-300">
                                        <div><span className="text-yellow-500 font-bold">ELECTRO</span> shocks <span className="text-[#d1d5db] font-bold">KINETIC</span></div>
                                        <div><span className="text-[#d1d5db] font-bold">KINETIC</span> grounds <span className="text-yellow-500 font-bold">ELECTRO</span></div>
                                        <div className="text-gray-500 italic pt-2 border-t border-gray-800 mt-2">Mutually destructive.</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-[#1e293b] border border-gray-700 p-6 shadow-md">
                            <h2 className="text-[#a855f7] font-bold text-xl uppercase tracking-widest mb-4">Environmental Reactions</h2>
                            <p className="text-gray-400 text-xs mb-4 leading-relaxed">
                                Striking a hex that is already painted with an Elemental Terrain using a specific opposing Element triggers a volatile chain reaction, instantly adding <strong className="text-white">+5 Absolute Damage</strong> to the payload.
                            </p>
                            <table className="w-full text-left text-xs border-collapse">
                                ...
                                <tbody className="text-gray-300">
                                    <tr className="border-b border-gray-700 bg-[#0f172a]/50">
                                        <td className="py-2 px-3 text-blue-400 font-bold">Cryo</td>
                                        <td className="py-2 px-3 text-red-500 font-bold">Thermal</td>
                                    ...
                                    <tr className="border-b border-gray-700 bg-[#0f172a]/50">
                                        <td className="py-2 px-3 text-blue-400 font-bold">Cryo / Steam</td>
                                        <td className="py-2 px-3 text-yellow-500 font-bold">Electro</td>
                                    ...
                                    <tr>
                                        <td className="py-2 px-3 text-[#a855f7] font-bold">Void <span className="text-gray-500">(or Radiant)</span></td>
                                        <td className="py-2 px-3 text-yellow-300 font-bold">Radiant <span className="text-gray-500">(or Void)</span></td>
                ...
                {activeTab === 'states' && (
                    <div className="animate-fade-in space-y-8 max-w-5xl">
                        <h1 className="text-3xl font-bold text-[#a855f7] uppercase border-b border-gray-700 pb-2">Status Conditions</h1>
                        ...
                        {[
                            ...
                            <div key={t.tier} className="bg-[#1e293b] border border-gray-700 shadow-md">
                                <div className="bg-[#0f172a] px-4 py-2 border-b border-gray-700">
                                    <h2 className="text-[#e9d5ff] font-bold uppercase tracking-widest">{t.title}</h2>
                                </div>
                                <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    {t.states.map(st => {
                                        const allowedElements = Object.keys(ELEMENT_STATE_MAP).filter(el => ELEMENT_STATE_MAP[el].includes(st));
                                        return (
                                            <div key={st} className="bg-[#0f172a] border border-gray-700 p-3 flex flex-col shadow-inner">
                                                <div className="font-bold text-white uppercase mb-1 flex justify-between">
                                                    <span className="text-[#a855f7]">[{st}]</span>
                                                </div>
                ...
                {activeTab === 'classes' && (
                    <div className="animate-fade-in space-y-8 max-w-5xl">
                        <h1 className="text-3xl font-bold text-[#d1d5db] uppercase border-b border-gray-700 pb-2">Class Synergy Matrix</h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {Object.entries(CLASS_AFFINITIES).filter(([name]) => name !== 'Rookie').map(([name, data]) => (
                                <div key={name} className="bg-[#1e293b] border border-gray-700 p-4 flex flex-col shadow-sm">
                                    <div className="flex justify-between items-start mb-2 border-b border-gray-800 pb-2">
                                        <h2 className="text-[#a855f7] font-bold text-xl uppercase tracking-widest">{name}</h2>
                                        <span className="bg-[#0f172a] text-white text-[10px] font-bold px-2 py-1 border border-gray-600 uppercase tracking-widest">{data.dp}</span>
                                    </div>
                                    ...
                                    <div className="mt-auto">
                                        ...
                                        <div className="flex flex-wrap gap-1">
                                            {data.states.map(st => (
                                                <span key={st} className="bg-[#0f172a] text-[#d1d5db] text-[10px] px-1.5 py-0.5 border border-gray-600 font-bold uppercase">{st}</span>
                                            ))}
                                        </div>
                                    </div>
                                </div>
                ...
                {activeTab === 'terrain' && (
                    <div className="animate-fade-in space-y-8 max-w-5xl">
                        <h1 className="text-3xl font-bold text-[#a855f7] uppercase border-b border-gray-700 pb-2">Grid Physics & Mobility</h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-[#1e293b] border border-gray-700 p-5 shadow-md">
                                ...
                                <div className="space-y-4 text-xs">
                                    <div className="bg-[#0f172a] p-3 border border-gray-700">
                                        <span className="text-[#a855f7] font-bold uppercase block mb-1">Minor Terrain [1u]</span>
                                        <p className="text-gray-400">Imposes physical drag. Movement through this hex costs exactly 2 Movement Points instead of 1.</p>
                                    </div>
                                    <div className="bg-[#0f172a] p-3 border border-gray-700">
                                        <span className="text-[#d1d5db] font-bold uppercase block mb-1">Clear Terrain [2u]</span>
                                        <p className="text-gray-400">Strips existing modifications from a hex, reverting it to a blank slate.</p>
                                    </div>
                                    <div className="bg-[#0f172a] p-3 border border-gray-700">
                                        <span className="text-[#a855f7] font-bold uppercase block mb-1">Major Terrain [3u]</span>
                                    ...
                                    <div className="bg-[#0f172a] p-3 border border-gray-700">
                                        <span className="text-[#e9d5ff] font-bold uppercase block mb-1">Severe Terrain [5u]</span>
                            ...
                            <div className="bg-[#1e293b] border border-gray-700 p-5 shadow-md">
                                ...
                                <div className="space-y-4 text-xs">
                                    <div className="bg-[#0f172a] p-3 border border-gray-700">
                                        <span className="text-[#d1d5db] font-bold uppercase block mb-1">Blink</span>
                                    ...
                                    <div className="bg-[#0f172a] p-3 border border-gray-700">
                                        <span className="text-[#a855f7] font-bold uppercase block mb-1">Push</span>
                                    ...
                                    <div className="bg-[#0f172a] p-3 border border-gray-700">
                                        <span className="text-[#a855f7] font-bold uppercase block mb-1">Pull</span>
                ...
                {activeTab === 'payloads' && (
                    <div className="animate-fade-in space-y-8 max-w-5xl">
                        <h1 className="text-3xl font-bold text-[#d1d5db] uppercase border-b border-gray-700 pb-2">Payloads & Teamwork</h1>
                        <p className="text-sm text-gray-400 leading-relaxed max-w-3xl mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                            <div className="bg-[#0f172a] border border-red-500 p-5 shadow-sm">
                            ...
                            <div className="bg-[#0f172a] border border-[#22c55e] p-5 shadow-sm">
                                ...
                                <ul className="text-[10px] text-gray-500 list-disc pl-4 space-y-1">
                                    ...
                                    <li>Automatically triggers Teamwork: <strong className="text-white">Assist</strong>.</li>
                                </ul>
                            </div>
                            <div className="bg-[#0f172a] border border-[#d1d5db] p-5 shadow-sm">
                                <h3 className="text-[#d1d5db] font-bold uppercase tracking-widest mb-2 text-lg">Energize</h3>
                                ...
                                <ul className="text-[10px] text-gray-500 list-disc pl-4 space-y-1">
                                    ...
                                    <li>Immediately adds to the target's Res pool (up to the 10 Res soft-cap).</li>
                                    <li>Automatically triggers Teamwork: <strong className="text-white">Assist</strong>.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#1e293b] border border-gray-700 p-6 shadow-md">
                            ...
                            <div className="space-y-3 text-sm">
                                <div className="flex justify-between items-center border-b border-gray-800 pb-2">
                                    <span className="text-[#a855f7] font-bold uppercase tracking-wider">Exploit (+4 Res)</span>
                                ...
                                <div className="flex justify-between items-center border-b border-gray-800 pb-2">
                                    <span className="text-[#a855f7] font-bold uppercase tracking-wider">Tag-Team (+4 Res)</span>
                                ...
                                <div className="flex justify-between items-center">
                                    <span className="text-[#a855f7] font-bold uppercase tracking-wider">Assist (+2 Res)</span>
